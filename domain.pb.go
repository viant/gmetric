...
type OperationMetric struct {
	...
	AvgValue     float64 `protobuf:"fixed64,8,opt,name=avgValue,proto3" json:"avgValue,omitempty"`
	MinValue     float64 `protobuf:"fixed64,9,opt,name=minValue,proto3" json:"minValue,omitempty"`
	MaxValue     float64 `protobuf:"fixed64,10,opt,name=maxValue,proto3" json:"maxValue,omitempty"`
}
...
func (m *OperationMetric) MarshalTo(data []byte) (int, error) {
	...
	if m.AvgValue != 0 {
		data[i] = 0x41
		i++
		i = encodeFixed64Domain(data, i, uint64(math.Float64bits(float64(m.AvgValue))))
	}
	if m.MinValue != 0 {
		data[i] = 0x49
		i++
		i = encodeFixed64Domain(data, i, uint64(math.Float64bits(float64(m.MinValue))))
	}
	if m.MaxValue != 0 {
		data[i] = 0x51
		i++
		i = encodeFixed64Domain(data, i, uint64(math.Float64bits(float64(m.MaxValue))))
	}
	return i, nil
}
...
var fileDescriptorDomain = []byte{
	...
	,
}
